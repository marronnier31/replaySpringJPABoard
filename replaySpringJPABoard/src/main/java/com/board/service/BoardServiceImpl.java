...
public class BoardServiceImpl implements BoardService {
	...
	public List<Board> search(String searchType, String keyword) throws Exception {
		if(searchType.equals("content")) return boardRepository.findByContentContaining(keyword);
		else if(searchType.equals("title")) return boardRepository.findByTitleContaining(keyword);
		else if(searchType.equals("writer")) return boardRepository.findByWriterContaining(keyword);
		else return boardRepository.findByTitleContaining(keyword);
	}
